...
class DevelopersCreate extends Component {
  constructor(props) {
    super(props);
  ...
  async retrieveDeveloper(id) {
      const response = await DevelopersService.getById(id)
  ...
  async handleSubmit(event) {
    ...
    const response = await DevelopersService.update(developer);
    ...
    return (
        <Container>
            <Row className="justify-content-center">
                <PageHeader title="Cadastrar um novo desenvolvedor"></PageHeader>
            </Row>
...
export default withRouter(DevelopersCreate)